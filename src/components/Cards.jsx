  ...
  return (
    <section className="bg-gray-50 py-16 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-6xl mx-auto">
        {/* Top Section - Find Studio, Become Verified Artist, and Virtual Gallery */}
        <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-6 lg:gap-8 mb-12">
          {/* Left Card - ArtDistrict */}
        ...
        {/* Second Row - Art Value Calculator & NFT Launch */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 mb-12">
          {/* Art Value Calculator */}
          <div className="relative bg-[#0A0A0A] p-6 lg:p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow overflow-hidden text-center md:text-left min-w-0">
            ...
            <div className="relative z-10 h-full flex flex-col">
              ...
              <p className="text-gray-300 leading-relaxed">
                Discover the true market value of your artwork. Powered by real market logic — not guesswork.
              </p>
              <p className="text-sm text-gray-400 mt-3 mb-6">
                Estimate pricing using demand, brand value, medium, and commission factors in minutes.
              </p>

              <button
                onClick={() => navigate('/art-value-calculator')}
                className="w-full mt-auto bg-gradient-to-r from-brand to-red-700 text-white px-6 py-3 rounded-full font-semibold hover:from-red-700 hover:to-brand transition-colors shadow-lg shadow-brand/25"
              >
                CALCULATE VALUE
              </button>
            </div>
          ...
          {/* NFT Launch */}
          <div className="relative text-white p-6 lg:p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow overflow-hidden min-w-0">
            <div
        ...
        {/* Bottom Section - Art Supply Store */}
